...
function createSimpleChair(x,y)
{
	return STRUCT([
				T([0,1,2])([x,y,floorHeight])( SIMPLEX_GRID([[(0.45)], [(0.05)], [0.7]])),
				T([0,1,2])([x,y+0.4,floorHeight])( SIMPLEX_GRID([[(0.45)], [(0.05)], [0.45]]) ),
				T([0,1,2])([x,y,floorHeight + 0.45])( SIMPLEX_GRID([[(0.45)], [(0.45)], [0.05]]) ) ]);
}
...
var chair0 = createSimpleChair(24,4);
chair0 = COLOR([0.5,0,0])(chair0); // Set red


exports.floor3d = floor3d = STRUCT([pools, tiles, bench, walls, ceiling, pillars, chair0]);
